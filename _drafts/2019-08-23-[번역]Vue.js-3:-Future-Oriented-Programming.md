...
> (역주) 현재는 `Function-based Component API` 에서 `Composition API`로 이름이 변경되었다. RFC는 [여기](https://github.com/vuejs/rfcs/pull/78) 현재 버전의 도큐먼트는 [여기](https://vue-composition-api-rfc.netlify.com/#summary)를 참고하면 된다.
...
> (역주) 해당 컴포넌트의 전체 코드는 [여기](https://github.com/enkot/vue-function-api-test/blob/master/src/components/PostsPageOptions.vue)서 확인하시면 됩니다.
...
https://github.com/vuejs/rfcs/issues/55 이거 읽고
현재 어떻게 변경되었는지, 어떻게 논의되고 있는지 읽고 위에 내용 수정해서 마무리 할 예정
